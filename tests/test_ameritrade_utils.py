...
class TestAmeritradeUtils(unittest.TestCase):
    ...
    @patch('trading_platform.tools.helpers.ameritrade_utils.auth')
    @patch('trading_platform.tools.helpers.ameritrade_utils.webdriver.Chrome')
    ...
    @patch('trading_platform.tools.helpers.ameritrade_utils.tda_auth')
    ...
    @patch('trading_platform.tools.helpers.ameritrade_utils.get_quote')
